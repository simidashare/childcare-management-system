...
.container {
  ...
  <body>
    <h1 class="site-heading text-center text-white d-none d-lg-block">
      <div class="sh-upper site-heading-upper text-primary mb-3 rotate-in-center"
        >Padstow Childcare Center</div
      >
      ...
      <div class="container">
        <div class="intro">
          <img
            ...
            src="./img/jordan-rowland-lfEX-fEN3zY-unsplash-1536x1024.jpg"
            alt=""
          />
