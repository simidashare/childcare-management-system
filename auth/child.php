                                ...
                                <div>
                                    <table class="table table-hover table-bordered">
                                        ...
                                        <tr scope="row">                          
                                            ...
                                            <td class="table-info">
                                            <div>
                                                <input type="radio" name="child_gender" value="M" class="gender_male"> 
                                                <label for="M">Male: <br></label>  
                                            </div>
                                            <div>
                                                <input type="radio" name="child_gender" value="F" class="gender_female"> 
                                                <label for="F">Female: <br></label> 
                                            </div>
                                            <div>
                                                <input type="radio" name="child_gender" value="O"class="gender_others">  
                                        ...
                                        <tr scope="row">
                                            <td class="table-primary">
                                            <label for="childAllergy">Child Allergy:</label></td>
                                     ...
                                     <div class="col-auto ml-auto btn-group flex-wrap btn-group-justified"
                                        style="width:100%">
                                        <td class="btn-group"><button class="btn btn-primary mb-2" id="addChild">Add</button></td>
                                        <td class="btn-group"><button class="btn btn-primary mb-2" id="removeChild">Delete</button></td>
                                        <td class="btn-group"><button class="btn btn-primary mb-2" id="updateChild">Update</button></td>
                                        <td class="btn-group"><button class="btn btn-primary mb-2" id="searchChild">Search</button></td>
                                        <td class="btn-group"><button class="btn btn-primary mb-2" id="viewAllChild">ViewAll</button></td>
                                    </div>
                                    <div>
