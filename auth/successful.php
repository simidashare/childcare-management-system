                            ...
                            <table class="table table-hover table-bordered"  >
                                <tr scope="row">
                                    <td class="align-middle ">
                                      ...
                                      <td class="align-middle">
                                        <select class="custom-input" type="text" name="child_id" id="child_id_load" value="0"></select>
                                      </td>  
                                </tr>
                                <tr scope="row">
                                    <td class="align-middle">
                                    ...
                                    <td class="align-middle">
                                        <select class="custom-input" type="text" name="alle_code" id="alle_code_load"></select>
                                    </td> 
                                    <td class="align-middle">
                                        <button class="btn btn-primary mb-2" id="addAllergy">Add</button>
                                        <button class="btn btn-primary mb-2"
                                        id="removeAllergy">Delete</button>
                                      </td>                                    
                                    </tr>
                                <tr scope="row">
                                    <td class="align-middle">
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <button class="btn btn-primary mb-2"
                                        id="removeGuardian">Delete</button>
                                      </td> 
                                </tr>
                                <tr scope="row">
                                    <td class="">
