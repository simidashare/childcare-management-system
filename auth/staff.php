  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" id="mainNav">
      ...
      <div class="about-heading-content"> 
          <div class="row">   
           <div class="col">        
             <form class="table-responsive bg-faded rounded p-5" name="staff" action="./staff-process.php" method="post">
                <div class="table-responsive">             
                  <div class="font-weight-bold text-info" style="text-align:center"><h3>Staff</h3></div>
                  <div>
                  <table class="table table-hover table-bordered">   
                    <tr scope="row">                          
                        ...
                        <td class="table-info"                              
                        >
                        <input name="staff_id"id="staff_id" type="text">                         
                      ...
                      <tr scope="row">
                        ...
                        <td class="table-info"  >
                        <input class="custom-input" type="text" name="staff_fname" id="staff_fname"  value>                            
                        </td>
                      </tr>
                      <tr scope="row">
                        <!-- <td > -->
                        ...
                        <td class="table-info"  >
                        <input class="custom-input" type="text" name="staff_lname" id="staff_lname" value>                            
                        </td>
                      </tr>   
                      <tr scope="row">                          
                        <td class="table-primary">
                        ...
                        <td class="table-info">
                          <div>
                            ...
                            <label for="staff_gender_m">Male: <br></label>  
                     
                            <input type="radio" name="staff_gender" id="staff_gender_f" value="F" > 
                            <label for="staff_gender_f">Female: <br></label> 
                       
                            <input type="radio" name="staff_gender" id="staff_gender_o" value="O" >  
                            <label for="staff_gender_o">Other: <br></label>
                          </div>
                        </td>
                      </tr>
                      <tr scope="row">
                        <td class="table-primary" >
                          <label for="staff_homePhone">Home Phone:</label>
                        </td>
                        
                        <td class="table-info"  >
                        <input class="custom-input" type="text" name="staff_homePhone" id="staff_homePhone" value>                            
                        </td>
                      </tr>  
                      <tr scope="row">
                        <td class="table-primary" >
                          <label for="staff_workPhone">Work Phone:</label>
                        </td>
                        
                        <td class="table-info"  >
                        <input class="custom-input" type="text" name="staff_workPhone" id="staff_workPhone" value>                            
                        </td>
                      </tr> 
                      <tr scope="row">
                        <td class="table-primary" >
                          <label for="staff_mobile">Mobile Phone:</label>
                        </td>
                        
                        <td class="table-info"  >
                        <input class="custom-input" type="text" name="staff_mobile" id= "staff_mobile" value>                            
                        </td>
                      </tr>     
                      <tr scope="row">                          
                        <td class="table-primary" >
                        ...
                        <td class="table-info"  >
                        <input class="custom-input" type="text" name="registration_key" id= "registration_key" value>                            
                        </td>                        
                      </tr>  
                      <tr scope="row">                          
                        <td class="table-primary">
                          <label for="on_duty">On Duty</label>
                        </td>
                        <td class="table-info">
                          <div>
                            <input class="checkbox-margin" type="checkbox" name="on_duty" id="monday" value="1" > 
                            <label for="monday"> Monday <br></label>  
                     
                            <input class="checkbox-margin" type="checkbox" name="on_duty" id="tuesday" value="2" > 
                            <label for="tuesday"> Tuesday <br></label> 
                       
                            <input class="checkbox-margin" type="checkbox" name="on_duty" id="wednesday" value="3" >  
                            <label for="wednesday"> Wednesday <br></label>
                          </div>
                          <div>
                            <input class="checkbox-margin" type="checkbox" name="on_duty" id="thursday" value="4" > 
                            <label for="thursday"> Thursday <br></label>  
                     
                            <input class="checkbox-margin" type="checkbox" name="on_duty" id="friday" value="5" > 
                            <label for="friday"> Friday <br></label>

                            <input class="checkbox-margin" type="checkbox" name="on_duty" id="saturday" value="6"> 
                            <label for="saturday" > Saturday <br></label>
                          </div>
                        </td>
                      </tr>       
                    </table>
    ...
    <script src="../js/staff.js" type="module"></script>
