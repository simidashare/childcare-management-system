...
<head>
  ...
  <body>
                        ...
                        <div>
                            <table class="table table-hover table-bordered"  >
                                ...
                                <tr scope="row" id="change_to" class="myHidden" >
                                    <td class="table-primary ">
                                        <label for="child_id">Change to :</label>
                                    </td>

                                    <td class="table-info">
                                        <select class="custom-input" type="text" name="child_id"
                                            id="child_id_load2" value></select>
                                    </td>
                                </tr>
    ...
    <script src="../js/staff-child.js" type="module"></script>
