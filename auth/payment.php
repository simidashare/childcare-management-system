                                ...
                                <div>
                                    <table class="table table-hover table-bordered">
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="payment_id" id="payment_id">
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            <td class="table-primary">
                                        ...
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="payment_amountPaid" id="payment_amountPaid">
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            <td class="table-primary">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="payment_outstandingAmount" id="payment_outstandingAmount">
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            <td class="table-primary">
                                            <label for="enrolment_id">Enrolment Id:</label></td>
                                            <td class="table-info" > 
