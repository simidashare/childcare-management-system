...
<head>
  ...
  <body>
                                ...
                                <tr scope="row">
                                    <td class="align-middle table-primary">
                                      ...
                                      <td class="align-middle table-info">
                                        <select class="custom-input" type="text" name="family_id" id="family_id_load" ></select>
                                      </td>  
                                </tr>
                                <tr scope="row">
                                    ...
                                    <td class="table-info">
                                        <select class="custom-input" type="text" name="doc_id"
                                            id="doc_id_load" value="0"></select>
                                    </td>
                                </tr>
                                <tr scope="row" id="change_to" class="myHidden" >
                                    <td class="table-primary ">
                                        <label for="doc_id">Change to :</label>
                                    </td>

                                    <td class="table-info">
                                        <select class="custom-input" type="text" name="doc_id"
                                            id="doc_id_load2" value></select>
                                    </td>
                                </tr>
    ...
    <script src="../js/family-doctor.js" type="module"></script>
