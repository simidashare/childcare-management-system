      ...
      <div class="about-heading-content"> 
          <div class="row">   
           <div class="col-xl-9 col-lg-10 mx-auto">        
             <form class="table-responsive bg-faded rounded p-5" name="familyform" id="familyform" >
                <div class="table-responsive">             
                  <div class="font-weight-bold text-info" style="text-align:center"><h3>Family</h3>
                  </div>
                  ...
                  <table class="table table-hover table-bordered">   
                    <tr scope="row">                          
                        ...
                        <td class="table-info"                              
                        >
                        <select name="family_id" id="family_id_load">       
                          </select>                           
                        </td>                                              
                      </tr>
                      <tr scope="row">
                        ...
                        <td class="table-info"  >
                        <input class="custom-input" type="text" name="family_name" id="family_name">                            
                        </td>
                      </tr>           
                  </table>
                      <div>
                      ...
                      <div class="col-auto ml-auto btn-group flex-wrap btn-group-justified" style="width:100%">
                        <td class="btn-group"><button class="btn btn-primary mb-2"
                        onclick="return AddFamily()">Add</button></td>
                        <td class="btn-group"><button class="btn btn-primary mb-2"
                                onclick="return Deletefamily()">Delete</button></td>
                        <td class="btn-group"><button class="btn btn-primary mb-2"
                                onclick="return UpdateFamily()">Update</button></td>
                        <td class="btn-group"><button class="btn btn-primary mb-2"
                                onclick="return SearchFamily()">Search</button></td>
                        <td class="btn-group"><button class="btn btn-primary mb-2"
