                                ...
                                <div>
                                    <table class="table table-hover table-bordered">
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="enrolment_id" id="enrolment_id">
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            <td class="table-primary">
                                        ...
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="enrolment_numDays" id="enrolment_numDays">
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            <td class="table-primary">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="enrolment_numHours" id="enrolment_numHours">
                                            </td>
                                        </tr>
                                        <tr scope="row">                          
                                            <td class="table-primary">
                                            ...
                                            <td class="table-info">
                                            <div>
                                                <input type="radio" name="enrolment_status" value="Y" id="enrolment_status_y"> 
                                                <label for="enrolment_status"> Yes <br></label>  
                                            </div>
                                            <div>
                                                <input type="radio" name="enrolment_status" value="N" id="enrolment_status_n"> 
