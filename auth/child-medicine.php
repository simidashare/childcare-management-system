...
<head>
  ...
  <body>
                        ...
                        <div>
                            <table class="table table-hover table-bordered"  >
                                ...
                                <tr scope="row">
                                    ...
                                    <td class="table-info">
                                        <select class="custom-input" type="text" name="medicine_id"
                                            id="medicine_id_load" value="0"></select>
                                    </td>
                                </tr>
                                <tr scope="row" id="change_to" class="myHidden" >
                                    <td class="table-primary ">
                                        <label for="medicine_id">Change to :</label>
                                    </td>

                                    <td class="table-info">
                                        <select class="custom-input" type="text" name="medicine_id"
                                            id="medicine_id_load2" value></select>
                                    </td>
                                </tr>
    ...
    <script src="../js/child-medicine.js" type="module"></script>
