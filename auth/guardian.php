    ...
    <section class="page-section clearfix">
        <div class="container">
            <div class="about-heading-content">
                <div class="row">
                    <div class="col">
                        <form class="table-responsive bg-faded rounded p-5" name="guardianform" id="guardianform">
                                ...
                                <div>
                                    <table class="table table-hover table-bordered">
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="guardian_id"
                                                    id="guardian_id">
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            <td class="table-primary">
                                                <label for="guardian_fname">First Name:</label>
                                            </td>
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="guardian_fname"
                                                    id="guardian_fname">
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            <!-- <td > -->
                                            <td class="table-primary">
                                                <label for="guardian_lname">Last Name:</label>
                                            </td>
                                            <!-- <td > -->
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="guardian_lname"
                                                    id="guardian_lname">
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="guardian_address"
                                                    id="guardian_address">
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="guardian_phone"
                                                    id="guardian_phone">
                                            </td>
                                        </tr>
                                        <tr scope="row">
                                            ...
                                            <td class="table-info">
                                                <input class="custom-input" type="text" name="family_id" id="family_id">
                                            </td>
                                        </tr>
                                    </table>
                                    <div class="col-auto ml-auto btn-group flex-wrap btn-group-justified"
                                        ...
                                        <td class="btn-group"><button class="btn btn-primary mb-2"
                                                onclick="return AddGuardian()">Add</button></td>
                                        <td class="btn-group"><button class="btn btn-primary mb-2"
                                                onclick="return DeleteGuardian()">Delete</button></td>
                                        <td class="btn-group"><button class="btn btn-primary mb-2"
                                                onclick="return UpdateGuardian()">Update</button></td>
                                        <td class="btn-group"><button class="btn btn-primary mb-2"
                                                onclick="return SearchGuardian()">Search</button></td>
                                        <td class="btn-group"><button class="btn btn-primary mb-2"
                                                onclick="return ViewAll()">ViewAll</button></td>
                                    </div>
                                    <div>
