...
<html lang="en">
  ...
  <body>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            <li class="nav-item px-lg-4">
              <div class="btn-group">
                <a
                  class="nav-link text-capitalize text-expanded dropdown-toggle"
            ...
            <li class="nav-item px-lg-4">
              <div class="btn-group">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="./child-allergy.php"
                    >Child-Allergy</a
                  >
                  <a class="dropdown-item" href="./child-guardian.php"
                    >Child-Guardian</a
                  >
                  <a class="dropdown-item" href="./family-doctor.php"
                    >Family-Doctor</a
                  >
                  <a class="dropdown-item" href="./child-medicine.php"
                    >Child-Medicine</a
                  >
                  <a class="dropdown-item" href="./staff-child.php"
                    >Staff-Child</a
                  >
                </div>
              </div>
            ...
            <li class="nav-item px-lg-4">
              <div class="btn-group">
                ...
                <div class="dropdown-menu">
                  <a id="iCanFly" class="dropdown-item" href="./successful.php"
                    >Quick Menu</a
                  >
      ...
      <div class="container">
        <div class="about-heading-content">
          <div class="row">
            <div class="col">
              <form
                class="table-responsive bg-faded rounded p-5"
                name="alleform"
                id="alleform"
              >
                <div class="table-responsive">
                  ...
                  <div>
                    <table class="table table-hover table-bordered">
                      ...
                      <tr scope="row">
                        <td class="table-primary">
                          <label for="alle_description"
                            >Allergy Description:</label
                          >
                        </td>
                        <td class="table-info">
                          <input
                      ...
                      <tr scope="row">
                        <td class="table-primary">
                          <label for="alle_symptoms">Symptoms:</label>
                        </td>
                      ...
                      <tr scope="row">
                        <td class="table-primary">
                          <label for="alle_dth">Cause Death?</label>
                        </td>
                        <td class="table-info">
                          <div>
                            <input type="radio" name="alle_dth" value="Y"
                            id="alle_dth_y"/>
                            <label for="alle_dth_y">  Yes  </label>
                          </div>
                          <div>
                            <input type="radio" name="alle_dth" value="N" id="alle_dth_n"/>
                            <label for="alle_dth_n"> No </label>
                          </div>
                        </td>
                      </tr>
                    </table>
    ...
    <script src="../js/allergy.js" type="module"></script>
